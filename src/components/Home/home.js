...
// import banner1 from "./img/bg_banner1.jpg"
        ...
        <>
            ...
            <footer>
                ...
                <div class="footer-bottom text-center">
                    <p class="mb-0">Copyright vicpra 2022. All rights Reserved</p> Distributed By <a hrefs="https://themewagon.com">ThemeWagon</a>
                </div>
            </footer>
                            ...
                            <div class="container-fluid">
                                <div class="row gy-4">
                                    <div class="col-lg-4 col-sm-12 bg-cover"
                                        style={{backgroundImage: "url(img/c2.jpg)", minHeight:300+"px"}}>
                                        <div>
